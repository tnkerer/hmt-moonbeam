...
contract HMToken is HMTokenInterface {
    ...
    */
    ...
    constructor(uint256 totalSupply_, string memory name_, uint8 decimals_, string memory symbol_) public {
    ...
    function transferFrom(address _spender, address _to, uint256 _value) public override returns (bool success) {
        ...
        _balances[_spender] = _balances[_spender].sub(_value, "Spender balance too low");
